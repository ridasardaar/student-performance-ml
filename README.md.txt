...
- Decision Tree achieved the best performance by capturing non-linear patterns
- Random Forest improved upon Linear Regression but did not outperform the Decision Tree model in this case
...
Decision Tree achieved the best performance in this project, demonstrating the importance of capturing non-linear relationships in educational data.
